 ...
 * \param[in] pull_mode Pin pull mode
 */
static inline void Tx_Enable_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTA_set_pin_pull_mode(6, pull_mode);
}

/**
 * \brief Set Tx_Enable data direction
 *
 * Select if the pin data direction is input, output or disabled.
 * If disabled state is not possible, this function throws an assert.
 *
 ...
 *                      (low power state)
 */
static inline void Tx_Enable_set_dir(const enum port_dir dir)
{
	PORTA_set_pin_dir(6, dir);
}

/**
 * \brief Set Tx_Enable input/sense configuration
 *
 * Enable/disable Tx_Enable digital input buffer and pin change interrupt,
 * select pin interrupt edge/level sensing mode
 *
 * \param[in] isc PORT_ISC_INTDISABLE_gc    = Iterrupt disabled but input buffer enabled
 *                PORT_ISC_BOTHEDGES_gc     = Sense Both Edges
...
/**
 * \brief Set Tx_Enable inverted mode
 *
 * Enable or disable inverted I/O on a pin
 *
 * \param[in] inverted true  = I/O on Tx_Enable is inverted
 *                     false = I/O on Tx_Enable is not inverted
 */
static inline void Tx_Enable_set_inverted(const bool inverted)
{
	PORTA_pin_set_inverted(6, inverted);
}

/**
 * \brief Set Tx_Enable level
 *
 * Sets output level on a pin
 *
 * \param[in] level true  = Pin level set to "high" state
 *                  false = Pin level set to "low" state
 */
static inline void Tx_Enable_set_level(const bool level)
{
	PORTA_set_pin_level(6, level);
}

/**
 * \brief Toggle output level on Tx_Enable
 *
 * Toggle the pin level
 */
static inline void Tx_Enable_toggle_level()
{
	PORTA_toggle_pin_level(6);
}

/**
 * \brief Get level on Tx_Enable
 *
 * Reads the level on a pin
 */
static inline bool Tx_Enable_get_level()
{
